...
import { ChallengeMySuffixComponent } from 'app/entities/challenge-my-suffix/challenge-my-suffix.component';
...
describe('Component Tests', () => {
    describe('ChallengeMySuffix Management Component', () => {
        let comp: ChallengeMySuffixComponent;
        let fixture: ComponentFixture<ChallengeMySuffixComponent>;
        let service: ChallengeMySuffixService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [TreasureHuntTestModule],
                declarations: [ChallengeMySuffixComponent],
                providers: [
                    {
                ...
                .overrideTemplate(ChallengeMySuffixComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(ChallengeMySuffixComponent);
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new ChallengeMySuffix('123')],
                        headers
                    })
                )
            );
