...
import { ILocationMySuffix, LocationMySuffix, LocationType } from 'app/shared/model/location-my-suffix.model';
...
describe('Service Tests', () => {
    describe('LocationMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new LocationMySuffix('ID', LocationType.INSIDE, 'AAAAAAA');
        });
