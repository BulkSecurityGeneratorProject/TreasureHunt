package com.jfn.treasure.config;
...
@Configuration
@EnableMongoRepositories("com.jfn.treasure.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.jfn.treasure.config.dbmigrations");
